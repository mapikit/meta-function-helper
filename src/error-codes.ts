...
export enum ValidationErrorCodes {
  ...
  V02 = "V02 - Function Version is not a valid SemVer",
  ...
  V26 = "V26 - Given value is not a known Type",
  ...
  V34 = "V34 - Package file content is not an object",
  V35 = "V35 - Package name must be a string",
  V36 = "V36 - Package Version must be a SemVer string",
  V37 = "V37 - Package Description must be a string",
